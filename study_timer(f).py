...
if not _IS_FROZEN and not _BUILT_FLAG:
    ...
    out_name = "StudyTimer.exe" if platform.system() == "Windows" else "StudyTimer"
    ...
    build_cmd = [
        ...
        "--onefile", "--windowed", "--name", "StudyTimer",
    ...
    for cleanup in [os.path.join(script_dir, "StudyTimer.spec"), build_work, dist_temp]:
